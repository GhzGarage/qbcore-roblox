...
local PoliceService = requireLocalModule("PoliceService")
...
local JobRouteKit = requireLocalModule("JobRouteKit")
local GarbageJobService = requireLocalModule("GarbageJobService")
local DeliveryJobService = requireLocalModule("DeliveryJobService")
local BusJobService = requireLocalModule("BusJobService")
local TaxiJobService = requireLocalModule("TaxiJobService")
local TowJobService = requireLocalModule("TowJobService")
...
MedicalService.Start(InventoryService, VehicleService, BankingService)
PoliceService.Start(InventoryService, VehicleService)
...
JobRouteKit.Start(PlayerService, VehicleService)
GarbageJobService.Start(JobRouteKit)
DeliveryJobService.Start(JobRouteKit)
BusJobService.Start(JobRouteKit)
TaxiJobService.Start(JobRouteKit)
TowJobService.Start(JobRouteKit)
...
Players.PlayerRemoving:Connect(function(player)
	JobRouteKit.OnPlayerLeave(player)
